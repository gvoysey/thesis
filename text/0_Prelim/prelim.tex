...
\title{Development of a Flexible Modeling Environment for Evaluating Subcortical Auditory Systems}
...
\reader{Third}{Allyn E. Hubbard, PhD}{Professor of Electrical and Computer Engineering\\Professor of Biomedical Engineering}
\reader{Fourth}{Hideko Nakajima, MD, PhD}{Assistant Professor of Otology and Laryngology\\Harvard Medical School, Massachusetts Eye and Ear Infirmary}
% The Major Professor is the same as the first reader, but must be
% specified again for the abstract page
\numadvisors=1
\majorprof{H. Steven Colburn, PhD}{\mbox{Professor of Biomedical Engineering}}
