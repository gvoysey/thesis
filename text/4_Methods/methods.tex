...
\begin{figure}[htbp]
	...
	\caption{Curve-fitting of experimental results reported by \citeauthor{Temchin2008Threshold}.  Experimental data points (blue circles) were fit to a logistic model (red solid line).}
