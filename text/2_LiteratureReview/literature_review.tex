...
\subsection{Fiber Rates are Not Tonotopically Uniform} % (fold)
...
Ascending from the AN, auditory information passes through multiple brainstem and midbrain areas en route to the thalmus, and then auditory cortex.  A simplified schematic of pre-thalamic connections is given in \autoref{fig:comey-1}. 
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.95\textwidth]{comey-1.pdf}
	\caption[Ascending Auditory Pathway]{A simplified network diagram of the ascending auditory pathway in mammals.  Pathways in white arise from the DCN; pathways in black from the VCN.}
	\label{fig:comey-1}
\end{figure}
