...
Because we observe little difference in the Wave I and Wave V responses as a function of the types of synaptopathy modeled in \autoref{sec:effect_of_synaptopathy}, the relative effects of peripheral and brainsetm model types can be explored while holding the type of synaptopathy fixed.  This temporarily removes one dimension of the parameter space. 
